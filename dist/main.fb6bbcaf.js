...
},{"axios":"node_modules/axios/index.js"}],"js/validate.js":[function(require,module,exports) {
"use strict";
...
function showAlert(message, className) {
  ...
  container.insertBefore(div, form); //go away up to 3s
...
function fetchAnimals(e) {
  ...
  var zip = document.querySelector('#zip').value; //Validate zipcode
  ...
  client.animal.search({
    ...
    if (res.data.animals.length > 0) showAnimals(res.data.animals);else (0, _validate.showAlert)("There are any ".concat(animal, " in this region. Verify the Zip Code"), 'info');
  }).catch(function (err) {
...
},{"@petfinder/petfinder-js":"node_modules/@petfinder/petfinder-js/dist/petfinder.js","./validate":"js/validate.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
