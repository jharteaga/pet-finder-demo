...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/@petfinder/petfinder-js/dist/petfinder.js":[function(require,module,exports) {
var define;
...
var petForm = document.querySelector('#pet-form'); //Fetch animals from API
...
function fetchAnimals(e) {
  ...
  client.animal.search({
    ...
    return showAnimals(res.data.animals);
  }).catch(function (err) {
...
function showAnimals(animals) {
  ...
  animals.forEach(function (animal) {
    ...
    div.innerHTML = "\n        <div class=\"row\">\n            <div class=\"col-sm-6\">\n                <h4>".concat(animal.name, " (").concat(animal.age, ")</h4>\n                <p class=\"text-secondary\">").concat(animal.breeds.primary, "</p>\n                <p>").concat(animal.contact.address.address1 ? animal.contact.address.address1 : "", " ").concat(animal.contact.address.city, ", ").concat(animal.contact.address.state, ", ").concat(animal.contact.address.zip, "</p>\n                <ul class=\"list-group\">\n                    <li class=\"list-group-item\">Phone: ").concat(animal.contact.phone, "</li>\n                    ").concat(animal.contact.email ? "<li class=\"list-group-item\">Email: ".concat(animal.contact.email, "</li>") : "", "\n                    <li class=\"list-group-item\">Shelter ID: ").concat(animal.organization_id, "</li>\n                </ul>\n            </div>\n            <div class=\"col-sm-6 text-center\">\n                <img class=\"img-fluid rounded-circle mt-2\" src=\"").concat(animal.photos[0].medium, "\" alt=\"animal image\" />\n            </div>\n        </div>\n    ");
...
},{"@petfinder/petfinder-js":"node_modules/@petfinder/petfinder-js/dist/petfinder.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
